...
function CourseItem({ course, getAllCourses }) {
  ...
  return (
    <div className={styles.course_item_container}>
      ...
      {showEditModal && (
        <EditModal hideEditCourseModal={handelHideEditModal} course={course} />
      )}
      {showDeleteModal && (
        <DeleteModal
          hideDeleteModal={handelHideDeleteModal}
          deleteCourse={handelDeleteCourse}
        />
      )}
    </div>
  );
